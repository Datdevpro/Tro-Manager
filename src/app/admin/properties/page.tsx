          ...
          {properties.map((prop) => (
            ...
            >
              <div>
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="p-2 text-slate-400 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition"
                    ...
                    <button
                      ...
                      className="p-2 text-slate-400 dark:text-slate-500 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/30 rounded-lg transition"
                      title="Xóa khu trọ"
                    >
                ...
                {prop.description && (
                  <p className="text-xs text-slate-600 dark:text-slate-400 mt-4 line-clamp-2 bg-slate-50 dark:bg-slate-800/60 p-2.5 rounded-xl border border-slate-100 dark:border-slate-700">
                    {prop.description}
                  </p>
                )}
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 grid grid-cols-3 gap-2">
                  <div className="flex items-center gap-2 p-2 rounded-xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-100/80 dark:border-amber-800/40">
                    <Zap className="w-4 h-4 text-amber-600 shrink-0" />
                    <div className="min-w-0">
                      <span className="text-[10px] uppercase font-bold text-amber-700 dark:text-amber-400 tracking-wider block">
                        Giá điện
                      </span>
                      <span className="text-xs font-bold text-amber-900 dark:text-amber-300 truncate block">
                        {formatCurrency(prop.electricPrice)}/kWh
                      </span>
                    </div>
                  </div>

                  <div className="flex items-center gap-2 p-2 rounded-xl bg-cyan-50/70 dark:bg-cyan-950/30 border border-cyan-100/80 dark:border-cyan-800/40">
                    <Droplets className="w-4 h-4 text-cyan-600 shrink-0" />
                    <div className="min-w-0">
                      <span className="text-[10px] uppercase font-bold text-cyan-700 dark:text-cyan-400 tracking-wider block">
                        Giá nước
                      </span>
                      <span className="text-xs font-bold text-cyan-900 dark:text-cyan-300 truncate block">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 p-2 rounded-xl bg-purple-50/70 dark:bg-purple-950/30 border border-purple-100/80 dark:border-purple-800/40 hover:bg-purple-100/70 dark:hover:bg-purple-900/30 transition group"
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="text-xs font-bold text-purple-900 dark:text-purple-300 truncate block group-hover:underline">
              ...
              <div className="grid grid-cols-4 gap-2 pt-4 mt-4 border-t border-slate-100 dark:border-slate-800 text-center">
                ...
                <div className="bg-blue-50/60 dark:bg-blue-950/30 rounded-xl p-2">
                  <span className="text-[11px] text-blue-600 dark:text-blue-400 block font-medium">Đang thuê</span>
                  <span className="text-base font-bold text-blue-700 dark:text-blue-400">{prop.occupiedRooms}</span>
                </div>
                <div className="bg-emerald-50/60 dark:bg-emerald-950/30 rounded-xl p-2">
                  <span className="text-[11px] text-emerald-600 dark:text-emerald-400 block font-medium">Phòng trống</span>
                  <span className="text-base font-bold text-emerald-700 dark:text-emerald-400">{prop.availableRooms}</span>
                </div>
                <div className="bg-indigo-50/60 dark:bg-indigo-950/30 rounded-xl p-2">
                  <span className="text-[11px] text-indigo-600 dark:text-indigo-400 block font-medium">Khách ở</span>
                  <span className="text-base font-bold text-indigo-700 dark:text-indigo-400">{prop.totalTenants}</span>
                </div>
              </div>
            </div>
          ))}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="VD: 3500"
                  className="w-full px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition bg-white dark:bg-slate-800 text-slate-900 dark:text-white"
                />
              </div>
