        ...
        actions={
          <>
            <button
              ...
              className="px-3.5 py-2 text-xs font-semibold text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl shadow-xs transition flex items-center gap-1.5"
            >
              ...
              {loading ? (
                ...
                invoices.map((inv) => (
                  <tr key={inv.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition">
                    ...
                    <td className="px-5 py-4 text-slate-600 dark:text-slate-300 text-[11px] space-y-0.5">
                      ...
                      <div className="flex items-center justify-end gap-1">
                        ...
                        {inv.status !== "PAID" && (
                          <button
                            ...
                            className="p-1.5 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 rounded-lg transition font-semibold flex items-center gap-1"
        ...
        <form onSubmit={handleBulkGenerate} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30 font-semibold text-slate-800 dark:text-slate-200"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30 text-slate-800 dark:text-slate-200"
            />
          </div>

          <div className="p-3 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/80 rounded-xl text-xs text-amber-800 dark:text-amber-200 leading-relaxed">
        ...
        <form onSubmit={handleRecordPayment} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-base font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/30"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm font-medium text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/30"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm text-slate-800 dark:text-slate-200 placeholder:text-slate-500 dark:placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/30"
            />
          </div>
      ...
      >
        {viewingInvoice && (
          <div className="space-y-4 text-xs print:p-0">
            ...
            {/* Tenant & Room details */}
            <div className="grid grid-cols-2 gap-3 p-3.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl">
              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Phòng:</span>
                <span className="text-sm font-bold text-slate-900 dark:text-white">
                  {viewingInvoice.room?.roomNumber} ({viewingInvoice.room?.property?.name})
                </span>
              </div>
              <div>
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Người thuê:</span>
                <span className="text-sm font-bold text-slate-900 dark:text-white">
            ...
            <div className="border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
              <table className="w-full text-left">
                <thead className="bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 uppercase font-bold text-[10px]">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    <tr>
                      <td className="p-3 font-medium text-slate-800 dark:text-slate-200">
                        ...
                        {viewingInvoice.additionalFees && viewingInvoice.additionalFees.length > 0 && (
                          <div className="mt-1.5 space-y-1 bg-amber-50/70 dark:bg-amber-950/40 p-2 rounded-lg border border-amber-100 dark:border-amber-800/60 text-[11px] text-amber-900 dark:text-amber-200 font-normal">
                            <span className="font-semibold text-[10px] text-amber-800 dark:text-amber-300 uppercase tracking-wider block">Các khoản phát sinh:</span>
                  ...
                  {viewingInvoice.previousDebt > 0 && (
                    <tr>
                      <td className="p-3 font-medium text-rose-700 dark:text-rose-400">6. Nợ kỳ trước chuyển sang</td>
                  ...
                  {viewingInvoice.discount > 0 && (
                    <tr>
                      <td className="p-3 font-medium text-emerald-700 dark:text-emerald-400">7. Giảm giá / Khuyến mãi</td>
                ...
                <tfoot className="bg-indigo-50/50 dark:bg-indigo-950/40 border-t-2 border-indigo-100 dark:border-indigo-900/60 font-bold">
                  <tr>
                    <td className="p-3.5 text-sm text-slate-900 dark:text-white uppercase">Tổng cộng thanh toán:</td>
                    <td className="p-3.5 text-right text-base text-indigo-700 dark:text-indigo-300">
            ...
            {viewingInvoice.payments && viewingInvoice.payments.length > 0 && (
              <div className="p-3.5 bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/60 rounded-xl space-y-1.5">
                <span className="font-bold text-emerald-900 dark:text-emerald-200 block text-xs uppercase">
